              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-1">
                    Đang xem kết quả đã lọc
                  </h3>
                  <p className="text-sm md:text-base text-gray-600">
                    Hiển thị {filteredRooms.length} / {rooms.length} phòng khả dụng
                  </p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="group relative px-6 md:px-8 py-3 bg-white border-2 border-[#2fd680] text-[#2fd680] rounded-full font-semibold hover:bg-[#2fd680] hover:text-white hover:shadow-lg transition-all duration-300 flex items-center gap-2 whitespace-nowrap"
                >
            ...
            {filteredRooms.length === 0 && (
              <div className="flex flex-col items-center justify-center py-16 md:py-20 px-6">
                ...
                <p className="text-gray-600 text-center max-w-md">
                  Xin lỗi! Chúng tôi không có phòng phù hợp với tiêu chí của bạn. Vui lòng thử điều chỉnh bộ lọc hoặc xem tất cả phòng ở trên.
                </p>
              </div>
            )}
          </>
